...
//
///////////////////////////////////////////////////////////////////////////////
void SetAdvecSpeed(const dTensor2& phi, 
		   const dTensorBC4& q,
		   ...
		   SL_state& sl_state)
{
    ...
    // this:
    //
    // TODO - this function assumes that the splitting order reduces number of
    // poisson solves!
    // 
    ...
    if( dogParams.get_time_order() > 2 && (sl_state.stage_num % 2 == 0 ) )
