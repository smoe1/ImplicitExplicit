...
cflv(1)     = 0.05      ; max allowable Courant number 1/(2k-1)
cflv(2)     = 0.04      ; desired Courant number
    ...
    for i in range(iterations):
        ...
        with closing(open(data_file,'w')) as data:
            ...
            my_dictionary = {'s_order' : space_order, 't_order' : time_order, \
                    'mx' : mx_now, 'dt' : dt_now, "i_now": (i+n_start) }
...
if __name__ == '__main__':
    ...
    parser = optparse.OptionParser(
        usage='''%%prog (-h | [-i ITERATIONS] [-x MX_START]
