                    ...
                    dTensor2& source)
{
	...
	// Source term
	source.set(i,1,   0.0 );
        source.set(i,2 ,   ion_charge_dens*E1 + (J2_i*B3 - J3_i*B2));
        source.set(i,3 ,   ion_charge_dens*E2 + (J3_i*B1 - J1_i*B3));
        source.set(i,4 ,   ion_charge_dens*E3 + (J1_i*B2 - J2_i*B1));
        source.set(i,5 ,   J1_i*E1 + J2_i*E2 + J3_i*E3);
        source.set(i,6 ,   0.0 );
        source.set(i,7 ,   elc_charge_dens*E1 + (J2_e*B3 - J3_e*B2));
        source.set(i,8 ,   elc_charge_dens*E2 + (J3_e*B1 - J1_e*B3));
        source.set(i,9 ,   elc_charge_dens*E3 + (J1_e*B2 - J2_e*B1));
        source.set(i,10,   (J1_e*E1 + J2_e*E2 + J3_e*E3));
        source.set(i,11,   0.0 );
        source.set(i,12,   0.0 );
        source.set(i,13,   0.0 );
        source.set(i,14,   -J1*one_over_epsilon);
        source.set(i,15,   -J2*one_over_epsilon);
        source.set(i,16,   -J3*one_over_epsilon);
