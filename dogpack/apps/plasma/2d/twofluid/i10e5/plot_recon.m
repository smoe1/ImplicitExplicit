function plot_recon(outputdir_in,maxtime)
...
l1=legend('flux reconnected','flux exiting', 'flux across vertical axis', 'flux of central island','flux of other islands');
