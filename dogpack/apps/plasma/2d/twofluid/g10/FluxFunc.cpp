    ...
    dTensor3& flux)
{
    ...
    TenMomentFluxFunc(10, Q, flux);

    void MaxwellFluxFunc(
        int n_offset,
        const dTensor2& Q,
        dTensor3& flux);
    MaxwellFluxFunc(20, Q, flux);
    ...
    dTensor2& flux)
{
    ...
    TenMomentFluxFunc1(10, Q, flux);

    void MaxwellFluxFunc1(
        int n_offset,
        const dTensor2& Q,
        dTensor2& flux);
    MaxwellFluxFunc1(20, Q, flux);
    ...
    dTensor2& flux)
{
    ...
    TenMomentFluxFunc2(10, Q, flux);

    void MaxwellFluxFunc2(
        int n_offset,
        const dTensor2& Q,
        dTensor2& flux);
    MaxwellFluxFunc2(20, Q, flux);
